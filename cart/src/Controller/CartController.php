...
class CartController extends AbstractController
{
     ...
     */
    public function add(Products $product, SessionInterface $session , ProductsRepository $productsRepository)
    {
        ...
        if(empty($panier[$id])){
            ...
            $panier[$id] = 1;
            //$shop =new panier();
            //$shop ->setProduit($productsRepository->find($id));
            //$shop->setQuantite(1);
            //$shop->setPrix($productsRepository->find($id)->setPrice()*$shop->getQuantite());
